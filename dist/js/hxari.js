        ...
        $Bash.prototype.result = [
            {
                ...
                output: [
                    ...
                    "\\e[00m      7JJJYYJ?77??JJJJJJ?!!??:                 \\e[00mPlease type \\e[09m*\\e[00m to see the entire",
                    "\\e[00m      :JJJ?^.     .^!?JJJJJJ?.                 \\e[00mlist of existing commands.",
        ...
        $Bash.prototype.commands = [
            ...
            $Date.prototype.command,
            {
                ...
                callback: function({ $$del, $$get, $$set }, output = [] )
                {
                    if( $Is( $$del, String ) )
                    {
                        output.push( $Bash.prototype.message( "--del", $$del, this.cookie.del({ key: $$del }) ) );
                    }
                    if( $Is( $$set, Object ) )
                    {
                        output.push( $Bash.prototype.message( "--set", $$set.key, this.cookie.set( $$set ) ) );
                    }
                    if( $Is( $$get, String ) )
                    {
                        output.push( $Bash.prototype.message( "--get", $$get, this.cookie.get( $$get ) ) );
                    }
                    if( output.length === 0 )
                    {
                        output = [
